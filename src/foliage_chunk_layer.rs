  ...
  //  foliage_scene_data_resource: Res<FoliageSceneData > ,  //foliage layer data !!! 
    ...
    for  (chunk_layer_entity, chunk_layer, chunk_layer_parent )  in chunk_layer_query.iter(){
     ...
     let chunk_id = foliage_chunk.chunk_id; // need this for height data 
        ...
        let Some( foliage_definition_for_layer) = foliage_types_resource.0.foliage_definitions.get( layer_index ) else {
          ...
          let Some( layer_density_map) = &foliage_density_resource.0.get( &layer_index ) else {
          ...
          let chunk_height_data = & height_map_data;   // this data is specific to the chunk!! 
            ...
            let chunk_rows = foliage_config_resource.0.chunk_rows as i32 ;
            let height_scale = foliage_config_resource.0.height_scale; 
