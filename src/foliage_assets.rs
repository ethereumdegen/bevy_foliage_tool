...
#[derive(Debug, Clone)]
pub enum FoliageMaterialHandle {   //improve this ? 
    Standard(Handle<StandardMaterial>),
    Extended(Handle<FoliageMaterialExtension>)
...
impl FoliageAssetsResource {
	...
	pub fn register_foliage_material( &mut self,  name: impl ToString, handle: FoliageMaterialHandle ) {
